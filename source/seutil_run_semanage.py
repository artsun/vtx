...
def seutil_run_semanage():
    return\
    Data(title = 'Раскрытие макроса SELinux - seutil_run_semanage',
        schema = {'m000':
                   [
                    {'m01':
                         ['m10',
    ...
    voc = {
        ...
        'm00': ["проч. макросы", "прочие макросы", 0],
        'm01': ["seutil_run_semanage(domain , role)", "seutil_run_semanage($1, $2)", 0],
        'm02': ["проч. инструкции", "прочие инструкции", 0],
        'm03': ["seutil_run_setfiles(domain , role)", "см. соответствующую схему", 0],
        'm10': ["gen_require", "gen_require(`attribute_role semanage_roles;')", 0],
        'm11': ["seutil_domtrans_semanage()", "seutil_domtrans_semanage($1)", 0],
        'm12': ["roleattribute 2 semanage_roles", "roleattribute $2 semanage_roles;", 0],
        'm20': ["gen_require", "gen_require(`type semanage_t, semanage_exec_t;')", 0],
        'm21': ["files_search_usr()", "files_search_usr($1)", 0],
        'm22': ["corecmd_search_bin()", "corecmd_search_bin($1)", 0],
        'm23': ["domtrans_pattern()", "domtrans_pattern($1, semanage_exec_t, semanage_t)<br>/usr/share/selinux/devel/include/support/misc_patterns.spt", 0],
        'm24': ["semanage_roles", "roleattribute system_r semanage_roles;", 0],
    ...
    link={
        ...
        #'m00': Hlink('', ''),
        'm01': Hlink('selinuxutil.if', 'https://github.com/fedora-selinux/selinux-policy/blob/rawhide/policy/modules/system/selinuxutil.if#L1408'),
        #'m02': Hlink('', ''),
        'm10': Hlink('', ''),
        'm11': Hlink('selinuxutil.if', 'https://github.com/SELinuxProject/refpolicy/blob/master/policy/modules/system/selinuxutil.if#L988'),
        #'m12': Hlink('', ''),
        #'m20': Hlink('', ''),
        ...
        'm24': Hlink('selinuxutil.te', 'https://github.com/SELinuxProject/refpolicy/blob/master/policy/modules/system/selinuxutil.te#L20'),
        #'m30': Hlink('', ''),
        #'m31': Hlink('', ''),
        #'m32': Hlink('', ''),
